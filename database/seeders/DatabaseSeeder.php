...
class DatabaseSeeder extends Seeder
{
    ...
    private static function seedUsuario()
    {
            ...
            $u->password = bcrypt('borja');
            $u->administrador = true;
		    $u->save();
    }

    private static function seedProfesor()
    {
		    $u = new User;
            $u->name = 'Alberto';
            $u->email= 'alberto.sierra@murciaeduca.es';
            $u->password = bcrypt('alberto');
            $u->proveedor = true;
		    $u->save();
    }

    private static function seedUSuarioPrueba()
    {
		    $u = new User;
            $u->name = 'Prueba';
            $u->email= 'sinPermisos@peliculas.com';
            $u->password = bcrypt('sinpermisos');
		    $u->save();
    }
